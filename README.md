...
# **Wiki** - Harvard's CS50 2020

## Wikipedia-like online encyclopedia. This is the second project from CS50's Web Programming with Python and JavaScript.
...
### **Files & Directories**
- `encyclopedia` - app folder
  - `migrations` - migrations folder
  - `static/encyclopedia` - files folder
  - `templates/encyclopedia` - template folder
